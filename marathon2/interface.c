...
static void handle_load_game(void);
...
#ifdef DEBUG
struct screen_data *get_screen_data(
	short index)
{
...
#if 1
			if (sound= get_sound_resource_from_scenario(pict_resource_number))
			{
//				if (channel= (SndChannelPtr) NewPtrClear(sizeof(SndChannel)))
				{
